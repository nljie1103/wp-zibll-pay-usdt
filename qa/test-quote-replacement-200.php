...
// 2.1.1 quote replacement contract. The unique Zibll order number must move
...
fwrite(STDOUT, "OK: 2.1.1 atomic quote replacement and payment ownership contracts passed\n");
